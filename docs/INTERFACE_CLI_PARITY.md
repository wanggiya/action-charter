...
| Critic and release | Evidence inspection, trace adaptation/persistence, explicit validated critique, and immutable Critic-result recording available; release unavailable | Release readiness and creation |
