...
import { compilePlannerRecipe, compileRecipeProposal, createPlannerPlan, PlannerRequestError, executeExactPreview, loadCriticEvidence, loadDataResources, loadExecutionInventory, loadExecutionProgress, loadPlannerSkills, loadSavedPlans, loadSavedRecipes, prepareExecutionPreview, preparePlannerApproval, previewPlannerExecution, prepareRecipeApproval, recordPlannerApproval, recordRecipeApproval, runCriticAssessment, saveAdaptedRecipeTrace, saveCompiledPlannerRecipe, saveReviewedPlannerPlan, saveReviewedRecipe, verifyPlannerApproval, verifyRecordedRecipeApproval, type CompiledPlanRecipe, type CriticAssessmentResult, type CriticEvidenceInventory, type DataResourceInventory, type ExecutionInventory, type ExecutionPreview, type ExecutionProgress, type InterfaceCompilation, type InterfacePlannerResult, type PlanExecutionPreview, type PlannerSkillCatalog, type PreparedApprovalRequest, type PreparedPlanApproval, type RecipeExecutionResult, type RecordedPlanApproval, type RecordedRecipeApproval, type SavedInterfaceRecipe, type SavedPlanInventory, type SavedPlannerResult, type SavedRecipeInventory, type StoredRecipeTrace, type VerifiedPlanApproval, type VerifiedRecipeApproval } from "./lib/interface-api";
...
export default function App() {
  ...
  return <main className="app-shell">
    <header className="topbar">
      <div className="brand"><span className="brand-mark"><GitBranch size={18}/></span><span>ActionCharter</span><span className="checkpoint">17AT</span></div>
